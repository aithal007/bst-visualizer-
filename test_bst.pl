...
% Example 1: Build and query a tree
example1 :-
...
% Example 2: Demonstrate all operations
example2 :-
...
% Generate a list of N random-ish numbers
generate_numbers(0, []).
generate_numbers(N, [H|T]) :-
    N > 0,
    H is N * 7 mod 100,  % Simple pseudo-random
    N1 is N - 1,
